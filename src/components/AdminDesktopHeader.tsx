    ...
    return (
        <header className="hidden md:flex h-[64px] bg-[#1a1a1a] text-white items-center justify-between px-6 shrink-0 z-30">
            <div className="flex items-center gap-3">
                ...
                <span className="font-bricolage font-extrabold text-[18px] tracking-wide text-figma-cream">{t("app.name")}</span>
            </div>
            ...
            <div className="flex items-center gap-5">
                ...
                >
                    ...
                    <span className="text-[13px] font-bold text-figma-gold">{t("quickAdd.btnLabel")}</span>
                </button>
                ...
                <div className="flex items-center gap-4 pl-5 border-l border-[#333]">
                    <div className="flex items-center gap-2.5 px-3 py-1.5 rounded-[8px] bg-[#2a2a2a]">
                        ...
                        <span className="text-[13px] font-semibold text-gray-200">{t("common.user")}</span>
                        <span className="text-[10px] font-extrabold text-figma-dark bg-figma-gold px-2 py-0.5 rounded-[4px]">{t("common.admin")}</span>
                    </div>
